...
const BookingPage = () => {
  ...
  useEffect(() => {
    ...
    toast("Khung giờ bạn chọn vừa có người giữ mất rồi. Bạn đổi giờ khác giúp Dương Chí nhé!");
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-10">
      <h2 className="mb-6 text-center text-3xl font-bold text-rose-500">Giữ Lịch Tại Dương Chí</h2>
      <form
